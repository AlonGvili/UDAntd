...
/******/ 		return __webpack_require__.p + "" + ({"1":"ud-chart","2":"ud-monitor","3":"ud-link","4":"ud-input","5":"ud-counter","6":"ud-html","7":"ud-grid","8":"ud-date-time","9":"ud-element","10":"ud-icon","11":"ud-loading","12":"ud-page-cycler","13":"ud-modal","15":"vendors~ud-date-time","16":"vendors~ud-icon"}[chunkId]||chunkId) + "." + "62cdf2c93d53ea671cf2" + ".bundle.js"
/******/ 	}
/******/
...
var UniversalDashboardService = {
  ...
  provideRoutes: function provideRoutes() {
    return this.plugins.forEach(function (x) {
      try {
...
function (_React$Component) {
  ...
  ud_dashboard_createClass(UdDashboard, [{
    ...
    value: function render() {
      ...
      var staticPages = this.state.dashboard.pages.map(function (page) {
        return !page.dynamic && react_default.a.createElement(Route["a" /* default */], {
          key: page.name,
          exact: true,
          path: window.baseUrl + '/' + page.name.replace(/ /g, "-"),
          render: function render(props) {
            return react_default.a.createElement(ud_page_UdPage, _extends({
              onTitleChanged: _this.onTitleChanged.bind(_this),
              dynamic: false
      ...
      return [react_default.a.createElement("header", null, react_default.a.createElement(ud_navbar["a" /* default */], {
        ...
        fallback: react_default.a.createElement(react["Fragment"], null)
...
/******/ });
//# sourceMappingURL=main.62cdf2c93d53ea671cf2.bundle.map